class Api::V1::BuildingsController < Api::V1::BaseController
  ...
  def building_params
    params.require(:building).permit(:id, :name, :year, :architects, :neighborhood, :metro_stop, :address, :latitude, :longitude, :architectural_style, :contributor_author, :description, :fun_facts, :main_photo_credit, :user_id, :city, :fact_checked, :district, :favoritable_total, :favoritable_score, :main_picture, :old_address, photo_slider: [])
  end
end
